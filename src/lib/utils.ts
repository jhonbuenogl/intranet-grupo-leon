...
export const makeNotaDebitoJSON = () => {
  return {
    anticipos: [],
    close2u: {
      numero: "01",
    ...
    datosDocumento: {
      ...
      fechaVencimiento: "2023-08-28",
      formaPago: "EFECTIVO",
      glosa:
        "NO SE ACEPTA DESCUENTO MEDIANTE NC DE PARTE DE CLIENTE, SE REVISA CON FOPE",
      horaEmision: "15:  :00",
      puntoEmisor: null,
      moneda: "USD",
      numero: "0000003",
    ...
    detalleDocumento: [
      {
        ...
        codigoProductoSunat: "25101503",
        descripcion:
          "DESCUENTO POR BUY BACK - CAX102 - LJXCU2BB1NTF15725 - GARANTIAS( DESCUENTO POR BUY BACK - CAX102 - LJXCU2BB1NTF15725 - GARANTIAS )",
        descuento: {
          monto: 0,
        },
        isc: null,
        numeroOrden: 1,
        precioVentaUnitarioItem: null,
        tipoAfectacion: "GRAVADO_OPERACION_ONEROSA",
        unidadMedida: "UNIDAD_BIENES",
        valorReferencialUnitarioItem: null,
        valorVentaUnitarioItem: 7009.322033,
    ...
    detraccion: null,
    emisor: {
      correo: "sistemas11@autopartes.pe",
      correoCopia: null,
      domicilioFiscal: {
        departamento: "LIMA",
        direccion: "AV TOMAS MARSANO 280",
        distrito: "SURQUILLO",
        pais: "PERU",
        provincia: "LIMA",
        ubigeo: "150133",
        urbanizacion: "URB. BALCONCILLO",
      },
      nombreComercial: "LEON AUTOS S.A.",
      nombreLegal: "LEON AUTOS S.A.",
      numeroDocumentoIdentidad: "20601960762",
    ...
    receptor: {
      correo: "sistemas1@fastlane.pe",
      correoCopia: "",
      domicilioFiscal: {
        departamento: "15",
        direccion: "JR. LAS GARDENIAS 106 DPTO. 602 SANTIAGO DE SURCO LIMA",
      ...
      nombreComercial: "SKRABONJA CRESPO, ANA CECILIA",
      nombreLegal: "SKRABONJA CRESPO, ANA CECILIA",
      numeroDocumentoIdentidad: "10304628",
      tipoDocumentoIdentidad: "DOC_NACIONAL_DE_IDENTIDAD",
    },
    referencias: null,
    sector: {
      tipoTotalDescuentos: null,
      tipoCargo: null,
    },
  };
};
