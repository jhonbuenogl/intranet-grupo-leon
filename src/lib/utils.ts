...
export const makeNotaDebitoJSON = (voucher: any) => {
  return {
    anticipos: [],
    close2u: {
      numero: "",
    ...
    datosDocumento: {
      ...
      formaPago: voucher[0].formaPago,
      glosa: voucher[0].glosa,
      horaEmision: voucher[0].horaEmision,
      puntoEmisor: voucher[0].puntoEmisor,
      moneda: voucher[0].monedaDatosDoc,
      numero: voucher[0].numeroDatosDoc,
      ordencompra: voucher[0].ordencompra,
    ...
    descuentoGlobal: voucher[0].descuentoGlobal,
    detalleDocumento: [
      ...voucher.map((notaDebito: any) => ({
        cantidad: notaDebito.cantidadArt,
        codigoProducto: notaDebito.codigoProductoArt,
        codigoProductoGS1: notaDebito.codigoProductoGS1Art,
        codigoProductoSunat: notaDebito.codigoProductoSunatArt,
        descripcion: notaDebito.descripcionArt,
        descuento: {
          monto: notaDebito.montoDescuentoArt,
        },
        isc: notaDebito.iscArt,
        numeroOrden: notaDebito.numeroOrdenArt,
        precioVentaUnitarioItem: notaDebito.precioVentaUnitarioItem,
        tipoAfectacion: notaDebito.tipoAfectacion,
        unidadMedida: notaDebito.unidadMedidaArt,
        valorReferencialUnitarioItem: notaDebito.valorReferencialUnitarioItem,
        valorVentaUnitarioItem: notaDebito.valorVentaUnitarioItem,
    ...
    facturaGuia: voucher[0].facturaGuia,
    informacionAdicional: {
      coVendedor: voucher[0].coVendedor,
      fechaCreacion: voucher[0].fechaCreacionAdi,
      tipoOperacion: voucher[0].tipoOperacion,
      vendedor: voucher[0].vendedor,
    },
    otrosCargos: voucher[0].otrosCargos,
